...
export function InstallationProcess({ onViewClicked }: Props) {
  return (
    <>
      {/*<div className="text-gray-100 text-center mb-30">*/}
      ...
      {/*  <Link href='/' passHref><button className="btn btn-primary btn-md">Request Estimate</button></Link>*/}
      {/*  <Link href='/patio-packages' passHref><button className="btn btn-primary btn-md ml-20">Patio Packages</button></Link>*/}
      {/*</div>*/}

      {/*<HistoryTimeline timeline={ timeline } />*/}

      {/*<div className="flex justify-center">*/}
      {/*  <button className="btn btn-primary btn-md" onClick={onViewClicked}>View Project management</button>*/}
      {/*</div>*/}
    </>
  );
}
